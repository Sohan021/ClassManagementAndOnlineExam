...
namespace onlineexam.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public IActionResult ListUsersInRole(string id)
        {
            ...
            var user = context.Users.Where(u => u.Role.Id == id).ToList();
            return View(user);
        }

        [HttpGet]
        public IActionResult ListRolesUser()
        {
            var roles = roleManager.Roles;
            return View(roles);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> ListUsersInRole(List<UserRoleViewModel> model, string roleId)
        {
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            else
            {
                ...
                //user.UserIdentityId = model.UserIdentityId;
